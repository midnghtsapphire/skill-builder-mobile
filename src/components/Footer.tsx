...
const Footer = () => {
  return (
    <footer id="contact" className="py-16 bg-background border-t border-border/50">
        ...
        <div className="grid md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Practical training for the trades that build America.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-foreground transition-colors">HVAC</a></li>
              ...
              <li><a href="#" className="hover:text-foreground transition-colors">All Courses</a></li>
            </ul>
          </div>
